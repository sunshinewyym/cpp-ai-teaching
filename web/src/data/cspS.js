...
export const cspSProgramProblems = [
  ...
  },
  {
    ...
    "number": 1,
    "title": "完善程序第 1 题",
    "description": "（1）（第 k 小值）有两个长度分别为 n1 和 n2 的有序数组 a1 和 a2，将两个数组合并后，求第 k 小的值。\n\n试补全程序。\n\n```cpp\n#include <iostream>\n#include <algorithm>\n\nint kth(int *a1, int n1, int *a2, int n2, int k) {\n    int left1 = 0, right1 = n1 - 1, left2 = 0, right2 = n2 - 1;\n    while (left1 <= right1 && left2 <= right2) {\n        int m1 = (left1 + right1) >> 1;\n        int m2 = (left2 + right2) >> 1;\n        int cnt = ①;\n        if (②) {\n            if (cnt < k) left1 = m1 + 1;\n            else right2 = m2 - 1;\n        } else {\n            if (cnt < k) left2 = m2 + 1;\n            else right1 = m1 - 1;\n        }\n    }\n    if (③) {\n        if (left1 == 0) {\n            return a2[k - 1];\n        } else {\n            int x = a1[left1 - 1], ④;\n            return std::max(x, y);\n        }\n    } else {\n        if (left2 == 0) {\n            return a1[k - 1];\n        } else {\n            int x = a2[left2 - 1], ⑤;\n            return std::max(x, y);\n        }\n    }\n}\n\n```",
    "statement": "（1）（第 k 小值）有两个长度分别为 n1 和 n2 的有序数组 a1 和 a2，将两个数组合并后，求第 k 小的值。\n\n试补全程序。\n\n```cpp\n#include <iostream>\n#include <algorithm>\n\nint kth(int *a1, int n1, int *a2, int n2, int k) {\n    int left1 = 0, right1 = n1 - 1, left2 = 0, right2 = n2 - 1;\n    while (left1 <= right1 && left2 <= right2) {\n        int m1 = (left1 + right1) >> 1;\n        int m2 = (left2 + right2) >> 1;\n        int cnt = ①;\n        if (②) {\n            if (cnt < k) left1 = m1 + 1;\n            else right2 = m2 - 1;\n        } else {\n            if (cnt < k) left2 = m2 + 1;\n            else right1 = m1 - 1;\n        }\n    }\n    if (③) {\n        if (left1 == 0) {\n            return a2[k - 1];\n        } else {\n            int x = a1[left1 - 1], ④;\n            return std::max(x, y);\n        }\n    } else {\n        if (left2 == 0) {\n            return a1[k - 1];\n        } else {\n            int x = a2[left2 - 1], ⑤;\n            return std::max(x, y);\n        }\n    }\n}\n\n```",
    "questions": [
      {
        "number": 1,
        "text": "①处应填（）",
