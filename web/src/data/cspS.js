...
export const cspSChoicePapers = {
  ...
  "2023": [
    ...
    },
    {
      ...
      "answer": "C",
      "explanation": "????? C?void baz() { int a[1000]; baz(); }??????????????????????????????"
    },
    {
      "id": "2024-choice-4",
      "number": 4,
    ...
    },
    {
      "id": "2024-choice-6",
      "number": 6,
      "question": "?? f(1)=1???? n?2 ? f(n)=f(n-1)+f(?n/2?)?? f(4) ???? ?",
      "options": {
        "A": "4",
        "B": "5",
        "C": "6",
...
export const cspSProgramProblems = [
  ...
  },
  {
    ...
    "questions": [
      ...
      },
      {
        ...
        "score": 3,
        "id": "2024-reading-1-4",
        "explanation": "参考答案为 A（按位与）。请回到题目条件，按定义、执行顺序或复杂度逐项核对。"
      },
      {
        "number": 5,
      ...
      {
        "number": 6,
        "text": "假设数组 dp 长度无限制，函数 solve() 所实现的算法的时间复杂度是 O(n×2m)O(n\\times 2^m)O(n×2m)。（ ）",
        "options": {
          "A": "正确",
          "B": "错误"
        },
  ...
  },
  {
    ...
    "questions": [
      ...
      {
        "number": 3,
        "text": "当 n=10n = 10n=10 且 m=10m = 10m=10 时，有多少种输入使得两行的结果完全一致？（ ）",
        "options": {
          "A": "102410241024",
          "B": "111111",
          "C": "101010",
        ...
        "score": 3,
        "id": "2024-reading-2-3",
        "explanation": "参考答案为 B（111111）。请回到题目条件，按定义、执行顺序或复杂度逐项核对。"
      },
      {
        "number": 4,
        "text": "当 n≤6n \\leq 6n≤6 时，solve() 的最大可能返回值为（ ）？",
        "options": {
          "A": "656565",
          "B": "211211211",
          "C": "665665665",
        ...
        "score": 3,
        "id": "2024-reading-2-4",
        "explanation": "参考答案为 B（211211211）。请回到题目条件，按定义、执行顺序或复杂度逐项核对。"
      },
      {
        "number": 5,
        "text": "若 n=8,m=8n = 8, m = 8n=8,m=8，solve 和 solve2 的返回值的最大可能的差值为（ ）？",
        "options": {
          "A": "147714771477",
          "B": "199519951995",
          "C": "205920592059",
        ...
        "score": 3,
        "id": "2024-reading-2-5",
        "explanation": "参考答案为 C（205920592059）。请回到题目条件，按定义、执行顺序或复杂度逐项核对。"
      },
      {
        "number": 6,
