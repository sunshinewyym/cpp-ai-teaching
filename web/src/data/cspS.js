...
export const cspSChoicePapers = {
  ...
  "2023": [
    ...
    },
    {
      "id": "2024-choice-11",
      "number": 11,
      "question": "假设有一棵 hhh 层的完全二叉树，该树最多包含多少个结点？",
      "options": {
        "A": "2h−12^h-12h−1",
      ...
      "answer": "A",
      "explanation": "参考答案为 A（2h−12^h-12h−1）。请回到题目条件，按定义、计算顺序或程序执行过程逐项核对。"
    },
    {
      "id": "2024-choice-12",
      "number": 12,
      "question": "设有一个 101010 个顶点的完全图，每两个顶点之间都有一条边。有多少个长度为 444 的环？",
      "options": {
        "A": "120",
        "B": "210",
        "C": "630",
      ...
      "answer": "C",
      "explanation": "参考答案为 C（630）。请回到题目条件，按定义、计算顺序或程序执行过程逐项核对。"
    },
    {
      "id": "2024-choice-13",
      "number": 13,
      "question": "对于一个整数 nnn，定义 f(n)f(n)f(n) 为 nnn 的各位数字之和，问使 f(f(x))=10f(f(x))=10f(f(x))=10 的最小自然数 xxx 是多少？",
      "options": {
        "A": "29",
        "B": "199",
        "C": "299",
      ...
      "answer": "B",
      "explanation": "参考答案为 B（199）。请回到题目条件，按定义、计算顺序或程序执行过程逐项核对。"
    },
    {
      "id": "2024-choice-14",
      "number": 14,
      "question": "设有一个长度为 nnn 的 010101 字符串，其中有 kkk 个 111。每次操作可以交换相邻两个字符。在最坏情况下将这 kkk 个 111 移到字符串最右边所需要的交换次数是多少？",
      "options": {
        "A": "kkk",
        "B": "k×(k−1)/2k\\times (k-1)/2k×(k−1)/2",
        "C": "(n−k)×k(n-k)\\times k(n−k)×k",
        "D": "(2n−k−1)×k/2(2n-k-1)\\times k/2(2n−k−1)×k/2"
      },
      "explanation": "参考答案为 C（(n−k)×k(n-k)\\times k(n−k)×k）。请回到题目条件，按定义、计算顺序或程序执行过程逐项核对。",
      "answer": "C"
    },
    {
      "id": "2024-choice-15",
      "number": 15,
      "question": "如图是一张包含 777 个顶点的有向图，如果要删除其中一些边，使得从节点 111 到节点 777 没有可行路径，且删除的边数最少，请问总共有多少种可行的删除边的集合？（ ）",
      "options": {
        "A": "1",
        "B": "2",
        "C": "3",
      ...
      "explanation": "参考答案为 D（4）。请回到题目条件，按定义、计算顺序或程序执行过程逐项核对。",
      "answer": "D"
    }
  ],
  "2025": [
